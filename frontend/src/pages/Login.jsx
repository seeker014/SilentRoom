  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (data.token) {
        ...
        console.error("No token received from backend on login.");
      }
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8">
              ...
              <p className="text-gray-200 text-lg leading-relaxed">
                Welcome back to your anonymous community where you can continue sharing and connecting authentically.
              </p>
            </div>
          </div>
        </div>
